...
public class AuthActivityTest
{
    ...
    {
        Espresso.onView(ViewMatchers.withId(R.id.btnGoogle)).check(matches(isDisplayed()));
    }

    @Test
    public void authActivity_FacebookButton_isDisplayed()
    {
        Espresso.onView(ViewMatchers.withId(R.id.btnFacebook)).check(matches(isDisplayed()));
    }
}